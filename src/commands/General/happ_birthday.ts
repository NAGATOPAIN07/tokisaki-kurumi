...
export default class Command extends BaseCommand {
	...
	run = async (M: ISimplifiedMessage): Promise<void> => {
        ...
        await M.reply(
            ...
            undefined,
            undefined,
            `Cheers to you for another trip around the sun The day is all yours 💙Enjoy! wasting your money coz of your chumtiye friends. You are a gift yourself, and you deserve the best of everything. Happy birthday•\n 🥂🎂💙 *HAPPY BIRTHDAY* 🎂🥂\n🥳🥳🥳✨ Enyoy this special day in celebration of a most wonderful you🙂🥳🤩😍  *@${user.split('@')[0]}*\n\n`
        )
    }
}
